...
const secureOptions = 
 ...
 if (process.argv.length < 7){console.log(`Leaked by t.me/GodlyProof \nUsage: \nnode h2-godly host time req thread proxy file\nExample: node h2-godly https://google.com/ 60 64 10 proxy.txt `); process.exit();}
